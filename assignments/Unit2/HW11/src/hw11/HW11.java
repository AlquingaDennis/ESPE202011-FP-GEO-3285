...
public class HW11 {
    ...
    private static void VolcanicAccidents() {
    ...
    private static void MountainousAndGlacialFeatures() {
    ...
    private static void  fluvialAccidents() {
    ...
    private static void byinclination() {
